...
const productGroupNavOptions = [
  {
    label: "HOME",
    href: "/",
    imageLink: "/collections/ageGroup=Adults/main=Bottom",
    params: {
      ageGroup: "Adults",
      main: "Bottom",
    },
  ...
  // },
  {
    ...
    href: "/ready-to-wear",
    imageLink:
      "/collections/ageGroup=Adults/isReadyMade=true/productType=readyMadeCloth/main=Bottom",
    params: {
      isReadyMade: true,
      ageGroup: "Adults",
...
const BottomsChildrenSubMenus = ({
  ...
  const BottomsProductsDynamicFiltersQuery =
  ...
  const filteredProductsDynamicFilters = useMemo(() => {
    const productsDynamicFilters =
      BottomsProductsDynamicFiltersQuery?.data?.data || [];
  ...
  const getImageObj = () => {
    ...
    if (pathname === "/" || productGroupPage === "HOME") {
      imgaeObj.label = "Shop All Bottoms";
    }
    if (pathname === "/bespoke" || productGroupPage === "BESPOKE") {
      imgaeObj.label = "Shop All Bespoke Bottoms";
    }
    if (pathname === "/ready-to-wear" || productGroupPage === "READY TO WEAR") {
      imgaeObj.label = "Shop All Ready to Wear Bottoms";
    }
...
export default BottomsChildrenSubMenus;
