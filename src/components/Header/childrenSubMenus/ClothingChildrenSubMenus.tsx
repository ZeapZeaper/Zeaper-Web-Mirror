...
const productGroupNavOptions = [
  {
    ...
    href: "/",
    imageLink:
      "/collections/ageGroup=Adults/productType=bespokeCloth,readyMadeCloth",
    params: {
      ageGroup: "Adults",
      productType: "bespokeCloth,readyMadeCloth",
    },
    image: HomeImage,
    baseCollectionTitle: "Clothings",
  ...
  },
  {
    ...
    href: "/bespoke",
    imageLink:
      "/collections/ageGroup=Adults/isBespoke=true/productType=bespokeCloth",
    ...
    baseCollectionTitle: "Bespoke Clothings",
    subProductGroupPage: "BESPOKE CLOTHINGS",
  },
  {
    label: "READY TO WEAR",
    href: "/ready-to-wear",
    imageLink:
      "/collections/ageGroup=Adults/isReadyMade=true/productType=readyMadeCloth",
    params: {
      isReadyMade: true,
      ageGroup: "Adults",
    ...
    image: ReadyImage,
    baseCollectionTitle: "Ready to Wear Clothings",
    subProductGroupPage: "READY TO WEAR CLOTHINGS",
  },
];
...
const ClothingChildrenSubMenus = ({
  setHovered,
  setIsOpen,
  slideAnimate,
}: {
  ...
  const getImageObj = () => {
    ...
    if (pathname === "/" || productGroupPage === "HOME") {
      imgaeObj.label = "Shop All Clothings";
    }
    if (pathname === "/bespoke" || productGroupPage === "BESPOKE") {
      imgaeObj.label = "Shop All Bespoke Clothings";
    }
    if (pathname === "/ready-to-wear" || productGroupPage === "READY TO WEAR") {
      imgaeObj.label = "Shop All Ready to Wear Clothings";
    }
...
export default ClothingChildrenSubMenus;
