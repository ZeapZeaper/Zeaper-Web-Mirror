...
const productGroupNavOptions = [
  {
    label: "HOME",
    href: "/",
    imageLink: "/collections/ageGroup=Adults/main=Top",
    params: {
      ageGroup: "Adults",
      main: "Top",
  ...
  },
  {
    ...
    href: "/bespoke",
    imageLink:
      "/collections/ageGroup=Adults/isBespoke=true/productType=bespokeCloth/main=Top",
    ...
    baseCollectionTitle: "Bespoke Tops",
  ...
  },
  {
    ...
    href: "/ready-to-wear",
    imageLink:
      "/collections/ageGroup=Adults/isReadyMade=true/productType=readyMadeCloth/main=Top",
    params: {
      isReadyMade: true,
      ageGroup: "Adults",
    ...
    image: ReadyImage,
    baseCollectionTitle: "Ready to Wear Tops",
...
const TopsChildrenSubMenus = ({
  ...
  const TopsProductsDynamicFiltersQuery =
  ...
  const filteredProductsDynamicFilters = useMemo(() => {
    const productsDynamicFilters =
      TopsProductsDynamicFiltersQuery?.data?.data || [];
  ...
  const getImageObj = () => {
    ...
    if (pathname === "/" || productGroupPage === "HOME") {
      imgaeObj.label = "Shop All Tops";
    }
    if (pathname === "/bespoke" || productGroupPage === "BESPOKE") {
      imgaeObj.label = "Shop All Bespoke Tops";
    }
    if (pathname === "/ready-to-wear" || productGroupPage === "READY TO WEAR") {
      imgaeObj.label = "Shop All Ready to Wear Tops";
    }
...
export default TopsChildrenSubMenus;
