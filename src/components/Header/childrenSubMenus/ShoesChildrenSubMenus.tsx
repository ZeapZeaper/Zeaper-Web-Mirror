...
const productGroupNavOptions = [
  {
    ...
    params: {
      ageGroup: "Adults",
      productType: "bespokeShoe,readyMadeShoe",
    },
    image: HomeImage,
    baseCollectionTitle: "Shoes",
    subProductGroupPage: "SHOES",
  },
  {
    label: "BESPOKE",
    href: "/bespoke",
    ...
    baseCollectionTitle: "Bespoke Shoes",
    subProductGroupPage: "BESPOKE SHOES",
  },
  {
    label: "READY TO WEAR",
    href: "/ready-to-wear",
    ...
    image: ReadyImage,
    baseCollectionTitle: "Ready to Wear Shoes",
    subProductGroupPage: "READY TO WEAR SHOES",
  },
];
...
const ShoeChildrenSubMenus = ({
  ...
  const ShoesProductsDynamicFiltersQuery =
  ...
  const filteredProductsDynamicFilters = useMemo(() => {
    const productsDynamicFilters =
      ShoesProductsDynamicFiltersQuery?.data?.data || [];
  ...
  const getImageObj = () => {
    ...
    if (pathname === "/" || productGroupPage === "HOME") {
      imgaeObj.label = "Shop All Shoes";
    }
    if (pathname === "/bespoke" || productGroupPage === "BESPOKE") {
      imgaeObj.label = "Shop All Bespoke Shoes";
    }
    if (pathname === "/ready-to-wear" || productGroupPage === "READY TO WEAR") {
      imgaeObj.label = "Shop All Ready to Wear Shoes";
    }
...
export default ShoeChildrenSubMenus;
