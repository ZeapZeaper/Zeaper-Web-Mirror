...
const productGroupNavOptions = [
  {
    ...
    href: "/",
    imageLink:
      "/collections/ageGroup=Adults/productType=accessory/accessoryType=Bag",
    params: {
      ageGroup: "Adults",
...
export default BagsChildrenSubMenus;
