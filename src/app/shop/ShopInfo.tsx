...
const ShopInfo = ({ shop }: { shop: ShopInterface }) => {
  ...
  return (
    <div className="w-full lg-w-md p-4 bg-white border border-gray-200 text-black rounded-lg shadow sm:p-8 dark:bg-slate-800 dark:text-white dark:border-gray-700">
